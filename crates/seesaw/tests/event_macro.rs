...
#[seesaw_core::event(prefix = "order")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
#[serde(tag = "type")]
pub enum OrderEvent {
...
#[seesaw_core::event(prefix = "status")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
...
#[seesaw_core::event(prefix = "synthesis", ephemeral)]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
#[serde(tag = "type", rename_all = "snake_case")]
...
#[seesaw_core::event(prefix = "custom_name")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
pub struct MyThing {
    pub value: i32,
}
...
#[seesaw_core::event(prefix = "batch")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
#[serde(tag = "type", rename_all = "snake_case")]
pub enum BatchEvent {
...
#[seesaw_core::event(prefix = "custom")]
#[derive(Clone, serde::Serialize, serde::Deserialize)]
#[serde(tag = "type", rename_all = "snake_case")]
