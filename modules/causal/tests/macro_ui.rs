...
fn event_macro_ui() {
    ...
    t.pass("tests/ui/consumers_as_functions.rs");
    ...
    t.compile_fail("tests/ui/reactor_fn_missing_name.rs");
    t.compile_fail("tests/ui/projector_recorded_event_needs_kinds.rs");
}
