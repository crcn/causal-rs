  ...
  return (dispatch, getState) => {
    ...
    const fetchEvents = async () => {
      ...
      try {
        ...
        console.error("[seesaw-admin] fetch events failed:", e);
      }
    };
    ...
    const fetchCausalTree = async (seq: number) => {
      ...
      try {
        ...
        console.error("[seesaw-admin] fetch causal tree failed:", e);
      }
    };
    ...
    const fetchFlow = async (runId: string) => {
      ...
      try {
        ...
        console.error("[seesaw-admin] fetch flow failed:", e);
      }
    };
    ...
    const fetchFlowMetadata = async (runId: string) => {
      try {
        ...
        console.error("[seesaw-admin] fetch flow metadata failed:", e);
      }
    };
    ...
    const fetchLogs = async (filter: LogsFilter) => {
      try {
        ...
        console.error("[seesaw-admin] fetch logs failed:", e);
      }
    };
